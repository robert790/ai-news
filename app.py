...
def render_groq() -> None:
    ...
    ort_page_html = (
        ...
        + '</svg>'
        + '</a>'
        + '<a class="ort-cta ort-cta--amber" href="?section=prompts" title="Re-run all picks">'
        + 'Refresh'
        + '<svg viewBox="0 0 16 16" fill="none" aria-hidden="true">'
        + '<path d="M3 8a5 5 0 0 1 8.5-3.6L13 3M13 8a5 5 0 0 1-8.5 3.6L3 13M3 3h10v10" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>'
        + '</svg>'
        + '</a>'
        + '</div>'
        + '</div>'
