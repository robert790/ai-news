 ...
 * Removes the `title` field. Validator should fail with
 * "must be a non-empty string".
 */

const baseRecord: PromptRecord = {
  id: "fixture-good",
  slug: "fixture-good",
  // title intentionally omitted to trigger the missing-required-field rule
  category: "code",
  difficulty: "beginner",
...
export const promptRecords: PromptRecord[] = [baseRecord];